...
import org.openapitools.client.model.Datacenters;
...
public class DataCenterApi {
     ...
     */
    public okhttp3.Call datacentersGetCall(Boolean pretty, Integer depth, Integer xContractNumber, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call datacentersGetValidateBeforeCall(Boolean pretty, Integer depth, Integer xContractNumber, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = datacentersGetCall(pretty, depth, xContractNumber, _callback);
        return localVarCall;
     ...
     */
    public Datacenters datacentersGet(Boolean pretty, Integer depth, Integer xContractNumber) throws ApiException {
        ApiResponse<Datacenters> localVarResp = datacentersGetWithHttpInfo(pretty, depth, xContractNumber);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Datacenters> datacentersGetWithHttpInfo(Boolean pretty, Integer depth, Integer xContractNumber) throws ApiException {
        okhttp3.Call localVarCall = datacentersGetValidateBeforeCall(pretty, depth, xContractNumber, null);
     ...
     */
    public okhttp3.Call datacentersGetAsync(Boolean pretty, Integer depth, Integer xContractNumber, final ApiCallback<Datacenters> _callback) throws ApiException {

        okhttp3.Call localVarCall = datacentersGetValidateBeforeCall(pretty, depth, xContractNumber, _callback);
        Type localVarReturnType = new TypeToken<Datacenters>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
