...
public class PrivateCrossConnectApi {
     ...
     */
    public okhttp3.Call pccsDeleteAsync(String pccId, Boolean pretty, Integer depth, Integer xContractNumber, final ApiCallback<Object> callback) throws ApiException {
