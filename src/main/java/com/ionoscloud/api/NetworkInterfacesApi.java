...
public class NetworkInterfacesApi {
    ...
    /**
     * Retrieve a Network Interface (asynchronously)
     * Retrieves the attributes of a given network interface.
     * @param datacenterId The unique ID of the datacenter (required)
     * @param serverId The unique ID of the Server (required)
     * @param nicId The unique ID of the NIC (required)
    ...
    /**
     * List Network Interfaces (asynchronously)
     * Retrieves a list of network interfaces.
     * @param datacenterId The unique ID of the datacenter (required)
     * @param serverId The unique ID of the Server (required)
     * @param pretty Controls whether response is pretty-printed (with indentation and new lines) (optional, default to true)
    ...
    /**
     * Partially Modify a Network Interface (asynchronously)
     * You can use update attributes of a network interface.
     * @param datacenterId The unique ID of the datacenter (required)
     * @param serverId The unique ID of the Server (required)
     * @param nicId The unique ID of the NIC (required)
    ...
    /**
     * Create a Network Interface (asynchronously)
     * Adds a network interface to the target server. Combined count of network interfaces and volumes attached to the server should not exceed size 24.
     * @param datacenterId The unique ID of the datacenter (required)
     * @param serverId The unique ID of the Server (required)
     * @param nic Nic to be created (required)
     ...
     */
    public okhttp3.Call datacentersServersNicsPutCall(String datacenterId, String serverId, String nicId, NicPut nic, Boolean pretty, Integer depth, Integer xContractNumber, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = nic;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call datacentersServersNicsPutValidateBeforeCall(String datacenterId, String serverId, String nicId, NicPut nic, Boolean pretty, Integer depth, Integer xContractNumber, final ApiCallback _callback) throws ApiException {
    ...
    /**
     * Modify a Network Interface (asynchronously)
     * You can use update attributes of a network interface.
     * @param datacenterId The unique ID of the datacenter (required)
     * @param serverId The unique ID of the Server (required)
     * @param nicId The unique ID of the NIC (required)
