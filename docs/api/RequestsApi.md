...
⚠️ **Note**: the example bellow uses the requestsStatusGetWithHttpInfo which also returns the status code and the headers, if you don't
need them you may use requestsStatusGet instead
### Example
```java
// Import classes:
import com.ionoscloud.ApiClient;
