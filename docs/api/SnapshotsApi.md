...
⚠️ **Note**: the example bellow uses the snapshotsDeleteWithHttpInfo which also returns the status code and the headers, if you don't
need them you may use snapshotsDelete instead
### Example
```java
// Import classes:
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.snapshotsDeleteWithHttpInfo(snapshotId, pretty, depth, xContractNumber);
...
⚠️ **Note**: the example bellow uses the snapshotsFindByIdWithHttpInfo which also returns the status code and the headers, if you don't
need them you may use snapshotsFindById instead
### Example
```java
// Import classes:
import com.ionoscloud.ApiClient;
...
public class Example {
  public static void main(String[] args) {
    ...
    Integer xContractNumber = 56; // Integer | Users with multiple contracts must provide the contract number, for which all API requests are to be executed.
    try {
      ApiResponse<Snapshot> result = apiInstance.snapshotsFindByIdWithHttpInfo(snapshotId, pretty, depth, xContractNumber);
...
⚠️ **Note**: the example bellow uses the snapshotsGetWithHttpInfo which also returns the status code and the headers, if you don't
need them you may use snapshotsGet instead
### Example
```java
// Import classes:
import com.ionoscloud.ApiClient;
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ApiResponse<Snapshots> result = apiInstance.snapshotsGetWithHttpInfo(pretty, depth, xContractNumber, orderBy, maxResults, filters);
      System.out.println("Response: " + result.getData());
      System.out.println("Status Code: " + result.getStatusCode());
      System.out.println("Headers: " + result.getHeaders());
    } catch (ApiException e) {
...
⚠️ **Note**: the example bellow uses the snapshotsPatchWithHttpInfo which also returns the status code and the headers, if you don't
need them you may use snapshotsPatch instead
### Example
```java
// Import classes:
import com.ionoscloud.ApiClient;
...
public class Example {
  public static void main(String[] args) {
    ...
    Integer xContractNumber = 56; // Integer | Users with multiple contracts must provide the contract number, for which all API requests are to be executed.
    try {
      ApiResponse<Snapshot> result = apiInstance.snapshotsPatchWithHttpInfo(snapshotId, snapshot, pretty, depth, xContractNumber);
      System.out.println("Response: " + result.getData());
      System.out.println("Status Code: " + result.getStatusCode());
      System.out.println("Headers: " + result.getHeaders());
    } catch (ApiException e) {
...
⚠️ **Note**: the example bellow uses the snapshotsPutWithHttpInfo which also returns the status code and the headers, if you don't
need them you may use snapshotsPut instead
### Example
```java
// Import classes:
import com.ionoscloud.ApiClient;
...
public class Example {
  public static void main(String[] args) {
    ...
    SnapshotsApi apiInstance = new SnapshotsApi(defaultClient);
    String snapshotId = "snapshotId_example"; // String | The unique ID of the snapshot.
    properties = new SnapshotProperties(); // SnapshotProperties | 
    snapshot = new Snapshot(SnapshotProperties); // Snapshot | The modified snapshot
    Boolean pretty = true; // Boolean | Controls whether the response is pretty-printed (with indentations and new lines).
    Integer depth = 0; // Integer | Controls the detail depth of the response objects.  GET /datacenters/[ID]  - depth=0: Only direct properties are included; children (servers and other elements) are not included.  - depth=1: Direct properties and children references are included.  - depth=2: Direct properties and children properties are included.  - depth=3: Direct properties and children properties and children's children are included.  - depth=... and so on
    Integer xContractNumber = 56; // Integer | Users with multiple contracts must provide the contract number, for which all API requests are to be executed.
    try {
      ApiResponse<Snapshot> result = apiInstance.snapshotsPutWithHttpInfo(snapshotId, snapshot, pretty, depth, xContractNumber);
      System.out.println("Response: " + result.getData());
      System.out.println("Status Code: " + result.getStatusCode());
      System.out.println("Headers: " + result.getHeaders());
    } catch (ApiException e) {
