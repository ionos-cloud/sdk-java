...
public class LabelsApiTest {
    ...
    public void datacentersLabelsFindByKeyTest() throws ApiException {
        ...
        Integer offset = null;
        Integer limit = null;
        LabelResource response = api.datacentersLabelsFindByKey(datacenterId, key, pretty, depth, xContractNumber, offset, limit);
    ...
    public void datacentersServersLabelsPutTest() throws ApiException {
        ...
        Integer offset = null;
        Integer limit = null;
        LabelResource response = api.datacentersServersLabelsPut(datacenterId, serverId, key, label, pretty, depth, xContractNumber, offset, limit);
