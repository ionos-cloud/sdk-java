...
public class ServersApiTest {
     ...
     */
    @Test
    public void datacentersServersRemoteConsoleGetTest() throws ApiException {
        String datacenterId = null;
        String serverId = null;
        Boolean pretty = null;
        Integer depth = null;
        Integer xContractNumber = null;
        RemoteConsoleUrl response = api.datacentersServersRemoteConsoleGet(datacenterId, serverId, pretty, depth, xContractNumber);
     ...
     */
    @Test
    public void datacentersServersResumePostTest() throws ApiException {
        String datacenterId = null;
        String serverId = null;
        Boolean pretty = null;
        Integer depth = null;
        Integer xContractNumber = null;
        Object response = api.datacentersServersResumePost(datacenterId, serverId, pretty, depth, xContractNumber);
     ...
     */
    @Test
    public void datacentersServersSuspendPostTest() throws ApiException {
        String datacenterId = null;
        String serverId = null;
        Boolean pretty = null;
        Integer depth = null;
        Integer xContractNumber = null;
        Object response = api.datacentersServersSuspendPost(datacenterId, serverId, pretty, depth, xContractNumber);
     ...
     */
    @Test
    public void datacentersServersTokenGetTest() throws ApiException {
        String datacenterId = null;
        String serverId = null;
        Boolean pretty = null;
        Integer depth = null;
        Integer xContractNumber = null;
        Token response = api.datacentersServersTokenGet(datacenterId, serverId, pretty, depth, xContractNumber);
