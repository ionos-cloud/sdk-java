...
import org.openapitools.client.model.Lan;
import org.openapitools.client.model.LanNics;
import org.openapitools.client.model.LanPost;
import org.openapitools.client.model.LanProperties;
...
public class LanApi {
     ...
     */
    public okhttp3.Call datacentersLansGetCall(String datacenterId, Boolean pretty, Integer depth, Integer xContractNumber, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call datacentersLansGetValidateBeforeCall(String datacenterId, Boolean pretty, Integer depth, Integer xContractNumber, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = datacentersLansGetCall(datacenterId, pretty, depth, xContractNumber, _callback);
        return localVarCall;
     ...
     */
    public Lans datacentersLansGet(String datacenterId, Boolean pretty, Integer depth, Integer xContractNumber) throws ApiException {
        ApiResponse<Lans> localVarResp = datacentersLansGetWithHttpInfo(datacenterId, pretty, depth, xContractNumber);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Lans> datacentersLansGetWithHttpInfo(String datacenterId, Boolean pretty, Integer depth, Integer xContractNumber) throws ApiException {
        okhttp3.Call localVarCall = datacentersLansGetValidateBeforeCall(datacenterId, pretty, depth, xContractNumber, null);
     ...
     */
    public okhttp3.Call datacentersLansGetAsync(String datacenterId, Boolean pretty, Integer depth, Integer xContractNumber, final ApiCallback<Lans> _callback) throws ApiException {

        okhttp3.Call localVarCall = datacentersLansGetValidateBeforeCall(datacenterId, pretty, depth, xContractNumber, _callback);
        Type localVarReturnType = new TypeToken<Lans>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call datacentersLansNicsGetCall(String datacenterId, String lanId, Boolean pretty, Integer depth, Integer xContractNumber, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call datacentersLansNicsGetValidateBeforeCall(String datacenterId, String lanId, Boolean pretty, Integer depth, Integer xContractNumber, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = datacentersLansNicsGetCall(datacenterId, lanId, pretty, depth, xContractNumber, _callback);
        return localVarCall;
     ...
     */
    public LanNics datacentersLansNicsGet(String datacenterId, String lanId, Boolean pretty, Integer depth, Integer xContractNumber) throws ApiException {
        ApiResponse<LanNics> localVarResp = datacentersLansNicsGetWithHttpInfo(datacenterId, lanId, pretty, depth, xContractNumber);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<LanNics> datacentersLansNicsGetWithHttpInfo(String datacenterId, String lanId, Boolean pretty, Integer depth, Integer xContractNumber) throws ApiException {
        okhttp3.Call localVarCall = datacentersLansNicsGetValidateBeforeCall(datacenterId, lanId, pretty, depth, xContractNumber, null);
     ...
     */
    public okhttp3.Call datacentersLansNicsGetAsync(String datacenterId, String lanId, Boolean pretty, Integer depth, Integer xContractNumber, final ApiCallback<LanNics> _callback) throws ApiException {

        okhttp3.Call localVarCall = datacentersLansNicsGetValidateBeforeCall(datacenterId, lanId, pretty, depth, xContractNumber, _callback);
        Type localVarReturnType = new TypeToken<LanNics>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
