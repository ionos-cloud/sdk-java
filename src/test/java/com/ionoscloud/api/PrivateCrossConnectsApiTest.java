...
/**
 * API tests for PrivateCrossConnectsApi
 */
@Ignore
public class PrivateCrossConnectsApiTest {

    private final PrivateCrossConnectsApi api = new PrivateCrossConnectsApi();
    ...
    public void pccsPatchTest() throws ApiException {
        ...
        Integer offset = null;
        Integer limit = null;
        PrivateCrossConnect response = api.pccsPatch(pccId, pcc, pretty, depth, xContractNumber, offset, limit);
