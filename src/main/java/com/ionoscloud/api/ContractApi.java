...
public class ContractApi {
     ...
     */
    public Contract contractsGet(Boolean pretty, Integer depth, Integer xContractNumber,  String orderBy, Integer maxResults, Map<String, String> filters) throws ApiException {
        ApiResponse<Contract> localVarResp = contractsGetWithHttpInfo(pretty, depth, xContractNumber, orderBy, maxResults, filters);
     ...
     */
    public ApiResponse<Contract> contractsGetWithHttpInfo(Boolean pretty, Integer depth, Integer xContractNumber, String orderBy, Integer maxResults, Map<String, String> filters) throws ApiException {
     ...
     */
    public okhttp3.Call contractsGetAsync(Boolean pretty, Integer depth, Integer xContractNumber, String orderBy, Integer maxResults, Map<String, String> filters,final ApiCallback<Contract> callback) throws ApiException {
