...
public class TemplatesApiTest {
     ...
     */
    @Test
    public void templatesFindByIdTest() throws ApiException {
        String templateId = null;
        Integer depth = null;
        Template response = api.templatesFindById(templateId, depth);
    ...
    public void templatesGetTest() throws ApiException {
        Integer depth = null;
        Templates response = api.templatesGet(depth);
